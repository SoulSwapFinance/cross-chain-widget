...
export const useEstimate = () => {
    ...
    const totalWithRefundEstimate = useMemo(() => {
        ...
        const formattedFirstFeeCost = formatUnits((_a = firstFeeCost === null || firstFeeCost === void 0 ? void 0 : firstFeeCost.amount) !== null && _a !== void 0 ? _a : "0", firstFeeCost === null || firstFeeCost === void 0 ? void 0 : firstFeeCost.token.decimals);
        const formattedExpressFeeCost = formatUnits((_b = expressFeeCost === null || expressFeeCost === void 0 ? void 0 : expressFeeCost.amount) !== null && _b !== void 0 ? _b : "0", expressFeeCost === null || expressFeeCost === void 0 ? void 0 : expressFeeCost.token.decimals);
     ...
     */
    useTokensWithBalance(fromChain);
    useTokensWithBalance(toChain, "to");
    return {
        allFeeCosts,
        allGasCosts,
        crossChainGasFee,
