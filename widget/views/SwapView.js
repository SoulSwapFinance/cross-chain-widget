...
export const SwapView = () => {
    var _a, _b, _c, _d, _e;
    const { tokenItems, onSwapChange, fromPrice, fromPriceChanged, invertSwaps } = useSwap();
    ...
    const { toAmount, isFetching: isFetchingEstimate, squidRouteError, priceImpact, toAmountUSDFloat, sourceChainNativeToken, totalWithRefundEstimate, } = useEstimate();
    ...
    return (_jsxs("div", Object.assign({ className: "tw-rounded-b-box tw-relative tw-flex tw-h-full tw-grow tw-flex-col" }, {
        children: [_jsx("span", Object.assign({ className: "tw-flex tw-flex-col" }, {
            children: _jsxs("span", Object.assign({ className: "tw-flex tw-w-full tw-flex-col tw-items-center tw-gap-3" }, {
                children: [_jsx(SwapConfiguration, { id: "squid-swap-source", direction: "from", onPriceChange: (d) => fromPriceChanged(d), price: fromPrice, tokens: tokenItems.from, chains: supportedSourceChains, tokenBasePrice: (_a = tokenPrices.data) === null || _a === void 0 ? void 0 : _a.sourceTokenUsdPrice, selectedChainId: swapRoute === null || swapRoute === void 0 ? void 0 : swapRoute.fromChainId, selectedAddress: swapRoute === null || swapRoute === void 0 ? void 0 : swapRoute.fromTokenAddress }), _jsx("span", Object.assign({ className: "tw-relative tw-flex tw-w-full tw-justify-center" }, {
                    children: _jsx("span", Object.assign({ className: "tw-absolute" }, {
                        ...
                        }, { children: _jsx(HiArrowDown, { size: 16, className: "tw-text-primary-content tw-transition-all group-hover:tw-rotate-180" }) }))
                    }))
                })), _jsx(SwapConfiguration, {
            ...
            children: [_jsx(CollapsibleBox, Object.assign({
                isOpen: isCollapseBoxOpen, openOffset: `-${widgetHeaderSize.height + widgetHeaderSize.paddingY}px`, onClose: () => {
                    ...
                    children: [isFetchingEstimate ? (_jsxs("div", Object.assign({ className: "tw-flex tw-min-h-[31px] tw-flex-row tw-items-center tw-gap-1.5 tw-text-sm tw-font-semibold" }, { children: [_jsx(Loader, {}), _jsx("span", { children: "Fetching estimations" })] }))) : (_jsxs("button", Object.assign({ type: "button", onClick: () => setIsCollapseBoxOpen(true), className: "tw-flex tw-flex-col" }, { children: [_jsxs("span", Object.assign({ className: "tw-text-sm tw-font-semibold" }, { children: [_jsx("span", { children: roundNumericValue(totalWithRefundEstimate.totalAmount.toString(), 2, false, 4) }), " ", _jsx("span", Object.assign({ className: "tw-ml-0.5" }, { children: (_e = totalWithRefundEstimate === null || totalWithRefundEstimate === void 0 ? void 0 : totalWithRefundEstimate.feeToken) === null || _e === void 0 ? void 0 : _e.symbol })), " "] })), _jsx("span", Object.assign({ className: "tw-text-sm tw-text-neutral-content" }, { children: "Estimated fee" }))] }))), _jsxs("span", Object.assign({ className: "tw-flex tw-flex-row tw-gap-1.5" }, {
                        ...
                        })), _jsx("button", Object.assign({ type: "button", onClick: () => setIsCollapseBoxOpen(true) }, { children: _jsx("span", Object.assign({ className: "tw-relative tw-flex tw-h-7 tw-w-7 tw-items-center tw-justify-center" }, { children: _jsx(BsChevronDown, { className: clsx("rotate-0 cursor-pointer transition-transform tw-flex tw-flex-col") }) })) }))]
                    }))]
                }))
            }, { children: _jsx(SwapViewDetailsCollapsed, { isHighlightedExpress: isHighlightedExpress, isHighlightedGas: isHighlightedGas }) })), _jsx("span", Object.assign({ className: "tw-mb-2  tw-w-full tw-px-5" }, { children: squidRouteError ? (_jsx(SwapRouteError, { error: squidRouteError })) : (_jsx(SwapWarning, {})) }))]
        })), _jsxs("span", Object.assign({ className: " tw-mb-4 tw-flex tw-w-full tw-flex-col tw-items-center tw-gap-1 tw-px-5 tw-text-sm tw-font-semibold" }, { children: [_jsx(SubmitSwapBtn, { disabled: swapButtonDisabledConditions.some((c) => c) }), 
            // _jsx(PoweredBy, {})
        ] }))]
    })));
};
