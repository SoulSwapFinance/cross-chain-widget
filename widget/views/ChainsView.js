...
export const ChainsView = () => {
    ...
    const disabledChainTypes = direction === "from" ? [ChainType.Cosmos] : [];
    const [filteredChainsForSearch, setFilteredChainsForSearch] = useState([]);
    const fuse = new Fuse(chainItems !== null && chainItems !== void 0 ? chainItems : [], {
    ...
    return (_jsxs("div", Object.assign({ className: clsx(" tw-flex tw-h-full tw-flex-1 tw-flex-col tw-overflow-hidden", ((_b = (_a = config.style) === null || _a === void 0 ? void 0 : _a.advanced) === null || _b === void 0 ? void 0 : _b.transparentWidget) && "tw-bg-opacity-70") }, { children: [_jsx("span", Object.assign({ className: "tw-p-3" }, { children: _jsx(SearchInput, { autoFocus: true, placeholder: "Search chain", onSearchChange: inputChanged }) })), _jsx("div", Object.assign({ className: "tw-px-5 tw-pb-3 tw-text-base tw-font-semibold", style: { paddingBottom: "10px", paddingTop: "2px" } }, { children: "Supported chains" })), _jsxs("ul", Object.assign({ className: "tw-rounded-b-box tw-flex  tw-h-full tw-flex-col tw-flex-nowrap tw-overflow-auto tw-pb-[20px]" }, { children: [_jsx(ListItemAvatar, Object.assign({ imageUrl: logos.squidLogoPurple, onSelect: selectAllChains }, { children: _jsx("span", Object.assign({ className: "tw-flex tw-w-full tw-flex-col tw-gap-1" }, { children: _jsx("span", Object.assign({ className: "tw-flex" }, { children: _jsx("span", { children: "All Networks" }) })) })) })), filteredChainsForSearch === null || filteredChainsForSearch === void 0 ? void 0 : filteredChainsForSearch.sort((a, b) => {
