...
export const DestinationAddressView = () => {
    ...
    const { cosmosAddress, isConnected: cosmosConnected, cosmosConnectedWallet, } = useCosmosContext();
    ...
    const filteredWallts = useMemo(() => wallets.filter((wallet) => currentType === wallet.type), [currentType]);
    const { getCosmosWalletInfos } = useCosmos();
    const { widgetInIframe, walletHandledExternally } = useIntegratorContext();
    const [currentTab, setCurrentTab] = useState(0);
    const connectedAddress = currentType === ChainType.EVM ? evmAddress : cosmosAddress;
    const isConnected = currentType === ChainType.EVM ? evmConnected : cosmosConnected;
    ...
    const editAddress = () => {
        ...
        return (_jsxs("span", Object.assign({ className: "tw-items-left tw-flex tw-w-full tw-flex-col tw-gap-2" }, { children: [_jsx("span", Object.assign({ className: "tw-px-5 tw-text-base tw-font-semibold", style: { paddingTop: "46px", paddingBottom: "5px" } }, { children: "Add custom wallet address" })), _jsxs("span", Object.assign({ className: "tw-px-5" }, { children: [_jsxs("span", Object.assign({ className: "tw-relative tw-mb-2 tw-flex tw-w-full tw-flex-row tw-items-center tw-gap-2" }, { children: [_jsx("input", { className: clsx(`t-w-full tw-rounded-box tw-flex tw-min-h-[2rem] tw-grow tw-flex-row 
                ...
                tw-outline-none tw-outline-0 hover:tw-bg-base-100`, isUpdatedAddressValid && "tw-border-success", isUpdatedAddressValid === false &&
                  ...
                  tw-outline-none`), onClick: pasteFromClipboard }, { children: "Paste" }))) }))] })), _jsxs("span", Object.assign({ className: "tw-flex tw-flex-col tw-gap-2" }, { children: [isUpdatedAddressValid === false && errorMessage, isUpdatedAddressValid === true && successMessage, isGnosisContext &&
    ...
    return (_jsxs("div", Object.assign({ className: clsx("tw-flex tw-h-full tw-w-full tw-flex-1 tw-flex-col tw-overflow-hidden", ((_b = (_a = config.style) === null || _a === void 0 ? void 0 : _a.advanced) === null || _b === void 0 ? void 0 : _b.transparentWidget) && subTransparentClass) }, { children: [_jsxs("div", Object.assign({ className: "tw-bg-base-200", style: {
                    height: "38px",
                    margin: "0 20px",
                    position: "relative",
                    borderRadius: "8px",
