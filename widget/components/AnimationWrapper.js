...
export const AnimationWrapper = ({ lottieJsonFile, animReplacement, }) => {
    ...
    return (_jsxs("div", Object.assign({ style: {
            ...
            display: "flex",
            alignItems: "center",
        }, className: clsx("tw-transition-all", display ? "tw-opacity-100" : "tw-opacity-0") }, { children: [!config.hideAnimations && (_jsx(Player, { style: { height: 150 }, autoplay: true, loop: true, src: lottieJsonFile })), config.hideAnimations && animReplacement !== undefined && (_jsx(AnimRelacementWrapper, { children: animReplacement }))] })));
};
