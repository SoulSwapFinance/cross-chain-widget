...
export const SwapConfiguration = (_a) => {
    ...
    const editableAddressBtn = () => {
        ...
        return (_jsx(HoverButtonPrimary, {
            onClick: () => switchRoute(routes.destination, { direction: "to" }), hoverContent: _jsxs("span", Object.assign({ className: "tw-flex tw-flex-row tw-items-center tw-gap-1" }, { children: [_jsx("span", Object.assign({ className: "tw-normal-case" }, { children: "Add address" })), _jsx(HiPlus, { size: 13 })] })), content: _jsxs(_Fragment, {
                children: [(destinationAddressHasBeenUpdated === null || destinationAddressHasBeenUpdated === void 0 ? void 0 : destinationAddressHasBeenUpdated.updated) &&
    ...
    const selectToken = (_jsx(RouterLink, Object.assign({
        className: clsx("tw-w-5/12 sm:tw-w-1/2", selectedChain === undefined && "pointer-events-none"), params: {
        ...
        children: _jsx(DropdownBtn, {
            disabled: selectedChain === undefined, label: selectedChain && (selectedToken === null || selectedToken === void 0 ? void 0 : selectedToken.symbol)
