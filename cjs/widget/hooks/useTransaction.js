...
const types_1 = require("@safe-global/safe-apps-sdk/dist/src/types");
...
const useTransaction = () => {
    const signer = (0, wagmi_1.useSigner)();
    const { currentRoute } = (0, useSquidRouter_1.useSquidRouter)();
    const queryClient = (0, react_query_1.useQueryClient)();
    const { fromPrice, toPrice, squid, currentTransaction, config } = (0, useSquidStore_1.useSquidStore)();
    const { swapRoute } = (0, useSquidStore_1.useSwapRoutePersistStore)();
    const { connector: activeConnector } = (0, wagmi_1.useAccount)();
    const { fromChain, toChain, fromToken, toToken, destinationAddress } = (0, useSwap_1.useSwap)();
    const { getGnosisSafeContext } = (0, useGnosisContext_1.useGnosisContext)();
    const { connectedAddress: sourceUserAddress } = (0, useMultiChain_1.useMultiChain)(fromChain, fromToken);
    const sourceExplorerUrl = (0, react_1.useMemo)(() => {
        if (!fromChain ||
     ...
     */
    const squidRoute = (0, react_query_1.useQuery)((0, queries_keys_1.keys)({
        ...
        const params = {
            ...
            slippage: (_b = config.slippage) !== null && _b !== void 0 ? _b : constants_1.defaultSlippage,
        ...
        enabled: squid !== undefined &&
            ...
            (currentRoute === null || currentRoute === void 0 ? void 0 : currentRoute.path) !== routes_1.routes.transaction.path,
        cacheTime: 7500,
        staleTime: 4000,
     ...
     */
    const routeApproved = (0, react_query_1.useQuery)((0, queries_keys_1.keys)({
     ...
     */
    const approveRoute = (0, react_query_1.useMutation)((0, queries_keys_1.keys)({
        address: sourceUserAddress,
        apiUrl: config.apiUrl,
        ...
        onSuccess: (data, variable) => {
            queryClient.invalidateQueries((0, queries_keys_1.keys)({
                address: sourceUserAddress,
                apiUrl: config.apiUrl,
    ...
    const setTransactionState = (0, react_1.useCallback)(({ route, txHash, nonce, status, userAddress, axelarUrl, }) => {
        if (route && route.transactionRequest) {
            ...
            const currentTransaction = {
                ...
                sourceTxExplorerUrl: (0, transactionService_1.getExplorerTxUrl)(fromChain, txHash),
    ...
    const handleTransactionReplacementError = (0, react_1.useCallback)(({ error, route, status, userAddress, axelarUrl, }) => __awaiter(void 0, void 0, void 0, function* () {
        if (route && error.code === utils_js_1.Logger.errors.TRANSACTION_REPLACED) {
            ...
            if (route.transactionRequest && squidRoute.data) {
                ...
                const currentTransaction = setTransactionState({
                    ...
                    status,
                    axelarUrl: (0, transactionService_1.getAxelarExplorerTxUrl)(squid === null || squid === void 0 ? void 0 : squid.axelarscanURL, routeType, newHash),
                });
                if (currentTransaction) {
                    ...
                    useSquidStore_1.usePersistStore.setState({
                        transactionsHistory: (0, transactionService_1.replaceTransactionAtNonce)(newNonce, sourceUserAddress, useSquidStore_1.usePersistStore.getState().transactionsHistory, newHistoryElement),
                    });
                }
            }
            try {
     ...
     */
    const swapQuery = (0, react_query_1.useMutation)((route) => __awaiter(void 0, void 0, void 0, function* () {
        var _d, _e;
        if (route && !!squid && signer.isSuccess) {
            ...
            if (route.transactionRequest) {
                ...
                const currentTransaction = setTransactionState({
                    ...
                    userAddress: sourceUserAddress,
                    status: "loading",
                    axelarUrl: (0, transactionService_1.getAxelarExplorerTxUrl)(squid.axelarscanURL, routeType, hash),
                });
                // Persisting the transaction in local storage
                if (currentTransaction && squidRoute.data) {
                    const previousHistoryList = (_d = useSquidStore_1.usePersistStore.getState().transactionsHistory) !== null && _d !== void 0 ? _d : [];
                    const newHistoryElement = Object.assign(Object.assign({}, currentTransaction), { params: squidRoute.data.params });
                    useSquidStore_1.usePersistStore.setState({
            ...
            try {
                ...
                return handleTransactionReplacementError({
                    ...
                    status: "loading",
                    userAddress: sourceUserAddress,
                    axelarUrl: (0, transactionService_1.getAxelarExplorerTxUrl)(squid.axelarscanURL, (_e = route === null || route === void 0 ? void 0 : route.transactionRequest) === null || _e === void 0 ? void 0 : _e.routeType, hash),
                });
            }
        }
        ...
        onError: (error) => {
            ...
            const errorObject = (0, errorService_1.getTransactionError)(error);
            useSquidStore_1.useSquidStore.setState({
            ...
            if ((currentTransaction === null || currentTransaction === void 0 ? void 0 : currentTransaction.transactionId) &&
                (errorObject === null || errorObject === void 0 ? void 0 : errorObject.type) === error_1.TransactionErrorType.CALL_EXCEPTION) {
                useSquidStore_1.usePersistStore.setState({
                    transactionsHistory: (0, transactionService_1.updateTransactionHistoryStatus)(currentTransaction === null || currentTransaction === void 0 ? void 0 : currentTransaction.transactionId, "error", useSquidStore_1.usePersistStore.getState().transactionsHistory, undefined),
                });
            }
        },
        onSuccess: () => {
            const { currentTransaction } = useSquidStore_1.useSquidStore.getState();
            queryClient.invalidateQueries((0, queries_keys_1.keys)({}).balances());
            useSquidStore_1.useSquidStore.setState({
