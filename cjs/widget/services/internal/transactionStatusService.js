...
exports.getStepsInfos = exports.getHalfSuccessState = exports.getStepStatuses = void 0;
 ...
 */
const getStepStatuses = ({ transaction, statusResponse, onlyFullStatusStep, }) => {
    let firstStepStatus;
...
const getHalfSuccessState = (data) => {
    var _a, _b, _c;
    if ((data === null || data === void 0 ? void 0 : data.gasStatus) === transaction_1.AxelarStatusResponseType.GAS_PAID_NOT_ENOUGH_GAS &&
        (data === null || data === void 0 ? void 0 : data.status) !== transaction_1.AxelarStatusResponseType.DESTINATION_EXECUTING) {
        return "need_gas";
    }
    // Success cases
    if (constants_1.axelarSuccessStatuses.includes((_a = data === null || data === void 0 ? void 0 : data.status) !== null && _a !== void 0 ? _a : "")) {
        // "destination_executed" case
        if ((data === null || data === void 0 ? void 0 : data.status) === transaction_1.AxelarStatusResponseType.DESTINATION_EXECUTED ||
            (data === null || data === void 0 ? void 0 : data.status) === transaction_1.AxelarStatusResponseType.EXPRESS_EXECUTED) {
            if (((_b = data === null || data === void 0 ? void 0 : data.toChain) === null || _b === void 0 ? void 0 : _b.callEventStatus) ===
                transaction_1.AxelarStatusResponseType.CROSS_MULTICALL_EXECUTED) {
                return "success";
            }
            if (((_c = data === null || data === void 0 ? void 0 : data.toChain) === null || _c === void 0 ? void 0 : _c.callEventStatus) ===
                transaction_1.AxelarStatusResponseType.CROSS_MULTICALL_FAILED) {
...
exports.getHalfSuccessState = getHalfSuccessState;
const middleStepChecker = (statusResponse) => {
    const data = statusResponse === null || statusResponse === void 0 ? void 0 : statusResponse.data;
    const successState = (0, exports.getHalfSuccessState)(data);
    if (successState) {
        return successState;
    }
    if ((data === null || data === void 0 ? void 0 : data.status) === transaction_1.AxelarStatusResponseType.ERROR) {
        const { error } = data;
        if ((0, errorService_1.isStatusError)(error)) {
            if (error.errorType === error_1.SquidStatusErrorType.NotFoundError) {
                return "error";
            }
        }
        return "error";
...
const getStepsInfos = ({ fromChain, toChain, fromToken, toToken, amount, txType, transaction, statusResponse, }) => {
    var _a, _b;
    const [firstStepStatus, middleStepStatus, lastStepStatus] = (0, exports.getStepStatuses)({
        transaction,
        statusResponse,
    });
    ...
    switch (txType) {
        case transaction_1.TransactionType.CALL_BRIDGE_CALL:
            return [
                {
                    label: payLabel,
        ...
        case transaction_1.TransactionType.CALL_BRIDGE:
            return [
                {
                    label: payLabel,
                    status: firstStepStatus,
        ...
        case transaction_1.TransactionType.BRIDGE:
            return [
                {
                    label: payLabel,
                    status: firstStepStatus,
        ...
        case transaction_1.TransactionType.BRIDGE_CALL:
            return [
                {
                    label: payLabel,
                    status: firstStepStatus,
