...
const ShareOnTwitter = ({ fromToken, toToken, fromChain, toChain, }) => {
...
For projects that heal, and make the world bright.`,
    ...
    return ((0, jsx_runtime_1.jsx)("a", Object.assign({ target: "_blank", className: "tw-flex tw-flex-row tw-gap-1 tw-text-center", rel: "noreferrer", href: tweetUrl }, { children: (0, jsx_runtime_1.jsx)(LightButton_1.LightButton, Object.assign({ style: { minHeight: "28px" }, className: "tw-w-auto tw-px-3 tw-text-base tw-font-medium", size: "xs", light: "100" }, { children: (0, jsx_runtime_1.jsxs)("span", Object.assign({ className: "tw-flex tw-flex-row tw-items-center tw-gap-1" }, { children: [(0, jsx_runtime_1.jsx)("span", { children: "Share on Twitter" }), (0, jsx_runtime_1.jsx)(ImageWrapper_1.ImageWrapper, { className: "tw-h-4 tw-w-4", src: logos_1.logos.squidHeart })] })) })) })));
};
