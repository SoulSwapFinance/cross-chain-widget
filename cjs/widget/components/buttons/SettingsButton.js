...
const SettingsButton = () => {
    ...
    return ((0, jsx_runtime_1.jsx)(RouterLink_1.RouterLink, Object.assign({ to: routes_1.routes.settings }, { children: (0, jsx_runtime_1.jsx)(IconButton_1.IconButton, { hoverEffect: false, border: false, icon: fa_1.FaCog, size: 16, className: (0, clsx_1.default)("tw-bg-base-200 tw-p-2 tw-text-neutral-content", ((_b = (_a = config === null || config === void 0 ? void 0 : config.style) === null || _a === void 0 ? void 0 : _a.advanced) === null || _b === void 0 ? void 0 : _b.transparentWidget) && constants_1.subTransparentClass) }) })));
};
